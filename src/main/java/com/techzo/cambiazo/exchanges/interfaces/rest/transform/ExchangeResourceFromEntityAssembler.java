...
public class ExchangeResourceFromEntityAssembler {
        public static ExchangeResource toResourceFromEntity(Exchange entity) {
            return new ExchangeResource(entity.getId(), entity.getProductOwnId(), entity.getProductChangeId(), entity.getStatus(), entity.getExchangeDate(), entity.getCreatedAt(), entity.getUpdatedAt(), entity.getLocationId());
        }
}
